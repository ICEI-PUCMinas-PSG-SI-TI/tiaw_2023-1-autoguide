...
$("document").ready(() => {
  if (userlogado) {
    ...
    showAlert("Não há usuário logado", icons.ERROR, "top") //Imprime uma mensagem de erro
    setTimeout(function () {
...
if (userlogado) {
  let signinMenu = document.querySelector(".nav-items :first-child")
  let registerMenu = document.querySelector(".nav-items :nth-child(2)")
